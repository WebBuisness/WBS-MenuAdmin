  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-card border border-border rounded-2xl p-6 shadow-xl">
        ...
        <button
          onClick={() => reset()}
          className="mt-6 w-full h-11 rounded-lg bg-orange-500 hover:bg-orange-600 text-white font-medium inline-flex items-center justify-center gap-2 transition-colors"
        >
